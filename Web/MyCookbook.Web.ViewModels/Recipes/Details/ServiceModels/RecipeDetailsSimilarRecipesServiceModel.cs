namespace MyCookbook.Web.ViewModels.Recipes.Details.ServiceModels
{
    ...
    public class RecipeDetailsSimilarRecipesServiceModel : IMapFrom<Recipe>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<Recipe, RecipeDetailsSimilarRecipesServiceModel>()
                .ForMember(
