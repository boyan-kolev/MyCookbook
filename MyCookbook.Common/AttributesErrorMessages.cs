namespace MyCookbook.Common
{
    ...
    public static class AttributesErrorMessages
    {
        ...
        public const string StringLengthErrorMessage = "Полето \"{0}\" трябва да бъде с дължина между {2} и {1} символа!";
        ...
        public const string ComparePasswordsErrorMessage = "Паролите трябва да съвпадат!";
    }
}
